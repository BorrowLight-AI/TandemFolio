...
const EXCEPTIONS = {
  // Univer 0.25.1 omits this field from the published package metadata, but
  // ships an Apache License 2.0 LICENSE file. The XLSX build aliases its sole
  // optional service token to a local inert identifier, so package code is
  // not included in the generated plugin resource.
