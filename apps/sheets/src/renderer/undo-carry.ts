/**
 * Modified by TandemFolio contributors: use the browser renderer's unified
 * workbook-edit mutation as the non-carryable state boundary.
 *
...
export const VISUAL_UNDO_COMMAND_ID = 'sheets.mutation.workbook-edit-step'
