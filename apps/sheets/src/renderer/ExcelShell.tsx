...
const IN_TAB =
  new URLSearchParams(window.location.search).get('mode') === 'tab' || window.parent !== window
      ...
      <header className="excel-header">
        ...
        >
          ...
          <button
            ...
            data-tip={t('appOpenWorkbookTitle')}
            aria-label={t('appOpenXlsx')}
            onClick={onOpen}
          >
            <EditorFileIcon />
          </button>
        ...
        <RibbonGroup label={t('appGroupPageSetup')}>
          ...
          {largeMenu(
            ...
            [
              ...
              { value: 'page-layout:print-titles:set', label: t('appRepeatSelectedRows') },
