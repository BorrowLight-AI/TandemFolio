// Modified by TandemFolio contributors: browser-local scan dependencies and product wiring.
/**
...
import { FILE_READ_BATCH_CELLS, MAX_SCAN_CELLS } from './lazy-find'
...
const ERROR_VALUE_RE = /^#(DIV\/0!|N\/A|NAME\?|NULL!|NUM!|REF!|VALUE!|SPILL!|CALC!)/
