// Modified by TandemFolio contributors: browser-local scan budgets and mounted-session adaptation.
/**
 ...
 * underlying file via readSheetRangeMapped (journal edits included).
 * Focusing an out-of-window match
...
export class LazyExtendedFindModel extends FindModel {
  ...
  private async runScan(): Promise<void> {
    ...
    // Budget counts scanned extent, not hits. Counting hits would scan sparse multi-million-cell sheets
    // end to end.
    let scannedCells = 0
