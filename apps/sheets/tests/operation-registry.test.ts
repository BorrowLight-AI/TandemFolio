...
describe('XLSX operation registry', () => {
  ...
  it.each([
    ...
    ['use-in-formula:Revenue', 'xlsx.cell.set_formula'],
    ['create-names:top', 'xlsx.defined_name.create_from_selection'],
    ['create-names:left', 'xlsx.defined_name.create_from_selection'],
