...
export interface SavePdfRequest {
  ...
  stamps: StampInput[]
  /** True when `stamps` is the complete final GenOffice watermark/header-footer set. */
  replaceGeneratedStamps?: boolean
...
/** Browser host API exposed to the renderer as window.pdfApi. */
export interface PdfApi {
  ...
  /** Serialize the visible pending edits into standalone recovery bytes without saving or downloading. */
  createRecovery(request: SavePdfRequest): Promise<ArrayBuffer>
