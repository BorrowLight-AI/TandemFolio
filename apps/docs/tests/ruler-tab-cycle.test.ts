// Adapted from genspark-ai/genoffice@a5b5903 for the browser-owned DOCX renderer.
...
const section = { pageWidth: 12240, marginLeft: 1440, marginRight: 1440 } as never
...
describe('isRenderableTabStop', () => {
  it('hides clear stops while keeping actual stops visible', () => {
