...
// Mirror for non-React modules such as pagination and editor extensions;
...
export const t: TFunc = (key, params) =>
  translate(moduleLang, key as keyof (typeof strings)['zh'], params)
...
export function useI18n(): I18n {
  ...
  return {
    lang,
    t: (key, params) => translate(lang, key as keyof (typeof strings)['zh'], params),
