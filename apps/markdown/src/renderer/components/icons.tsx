 ...
 * suite; format-neutral editor chrome icons live in packages/ui, while the
 * markdown-only glyphs below stay on the same 16-grid / pinned-stroke contract.
 */
...
export function IconExportDocx(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M3 1.8h6l3 3v9.4H3V1.8Z" />
      <path d="M9 1.8v3h3M5.3 8h4.8M7.7 6.1V12M5.8 10.1l1.9 1.9 1.9-1.9" />
    </Svg>
  )
}
...
export function IconPrint(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M4 5V1.8h8V5M4 10.2H2.2V6.4h11.6v3.8H12" />
      <path d="M4 8.5h8v5.7H4V8.5ZM11.8 7h.1" />
    </Svg>
  )
}
