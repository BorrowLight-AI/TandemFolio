...
import { HostFullscreenButton } from '../host/HostFullscreenButton'
import { autoContextTabForElement, contextTabForElement, type ContextTab } from './context-tabs'

/** The browser/MCP host has no Electron native File menu, including on macOS. */
...
// Only the Electron macOS shell supplied a native File menu.
const TABS: readonly MainTab[] = HAS_NATIVE_FILE_MENU
              ...
              <div className="rb-drop-wrap">
                ...
                >
                  <span className="rb-big-icon">
                    ...
                    <span className="picture-tool-icon" aria-hidden="true">
