...
- **Status:** pre-release beta candidate. The 2026-09-07 source-current five-format evidence is approved and the generated projection is `ready: true`; native release CI and publication remain pending.
...
14.3 ms against 20 ms. That historical capture does not authorize packaging after the 2026-09-06 source changes.
