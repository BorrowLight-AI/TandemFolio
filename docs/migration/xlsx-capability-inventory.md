...
- Capability status: 118 XLSX registry operations (116 Agent-visible, two internal); the candidate-native migration adds calculation mode, explicit recalculation, Goal Seek, and native workbook themes while retaining the audited baseline command surface
