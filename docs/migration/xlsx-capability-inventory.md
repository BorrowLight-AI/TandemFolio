...
- Capability status: 117 XLSX registry operations (115 Agent-visible, two internal); the candidate-native migration adds calculation mode, explicit recalculation, and Goal Seek while retaining the audited baseline command surface
