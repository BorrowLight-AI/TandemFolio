...
- Tests: the root workspaces execute 340 passing test files plus one environment-conditional skip,
  for 4,464 passing assertions and one skipped assertion. Workspace assertions are Operation
  Contract 24, Host Bridge 44, DOCX 1,680, Markdown 127, XLSX 1,766 plus one environment skip,
