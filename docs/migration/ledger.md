...
- Tests: the root workspaces execute 370 passing test files plus one environment-conditional skip,
  for 4,676 passing assertions and one skipped assertion. Workspace assertions are Operation
  Contract 24, Host Bridge 44, DOCX 1,680, Markdown 127, XLSX 1,948 plus one environment skip,
