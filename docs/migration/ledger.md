...
- Tests: the root workspaces execute 320 passing test files plus one environment-conditional skip,
  ...
  Contract 24, Host Bridge 44, DOCX 1,680, Markdown 127, XLSX 1,558 plus one environment skip,
